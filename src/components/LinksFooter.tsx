// Enhanced by AI on 2025-08-14T15:51:40.503Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Discover the beauty of handcrafted jewelry, designed with passion and attention to detail. 
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Jewelry Lane, Suite 200</span>
              </div>
            </div>
